...
using ChatBoostSource = OneOf<ChatBoostSourcePremium, ChatBoostSourceGiftCode, ChatBoostSourceGiveaway>;

ChatBoostSource Parse(const Value& value, To<ChatBoostSource>);

void Serialize(const ChatBoostSource& obj, ValueBuilder& builder);
