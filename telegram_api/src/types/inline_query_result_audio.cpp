...
InlineQueryResultAudio Parse(const Value& value, To<InlineQueryResultAudio>) {
    ...
    obj.audio_duration = ParseComplex<Optional<Integer>>(value["audio_duration"]);
...
void Serialize(const InlineQueryResultAudio& obj, ValueBuilder& builder) {
    internal::Put(builder, "type", obj.type);
    internal::Put(builder, "id", obj.id);
    internal::Put(builder, "audio_url", obj.audio_url);
    ...
    internal::Put(builder, "audio_duration", obj.audio_duration);
